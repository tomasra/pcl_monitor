...
process.dumpToDB = cms.EDAnalyzer("DumpFileToDB",
                                calibFileConfig = cms.untracked.PSet(calibConstFileName = cms.untracked.string("MC39X/vdrift_MC_W_384startup3_vdrift_statByView.txt"),
...
#                                calibFileConfig = cms.untracked.PSet(calibConstFileName = cms.untracked.string("MyTables/START3X_V27_TTrig_PlusHalfWire.txt"),
#                                calibFileConfig = cms.untracked.PSet(calibConstFileName = cms.untracked.string("MuOnia/vdrift_pt100_testvdrift_statByView.txt"),
#                                  calibFileConfig = cms.untracked.PSet(calibConstFileName = cms.untracked.string("MyTables/vdrift_543_v8_p3_sigma.txt"),
