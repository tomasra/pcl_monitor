# /users/cerminar/HLTTau3Mu/V11 (CMSSW_4_4_0_HLT23)
...
HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/cerminar/HLTTau3Mu/V11')
)
...
HLT_Tau2Mu_RegPixTrack_v2 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0HighQ + hltPreTau2MuRegPixTrack + hltDimuonL1HQ2p1Filtered0 + HLTL2muonrecoSequence + hltTauTo2MuL2PreFiltered0 + HLTL3muonrecoSequence + hltTauTo2MuL3Filtered + hltDisplacedmumuVtxProducerTauTo2Mu + hltDisplacedmumuFilterTauTo2MuTight + HLTTauTo2MuRegionalPixelRecoSequence + hltTauTo2MuTrackFilter + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLTSchedule = cms.Schedule( *(HLT_Tau2Mu_RegPixTrack_v1, HLT_Tau2Mu_RegPixTrack_v2, HLTriggerFinalPath ))
