# /users/cerminar/HLTTau3Mu/V7 (CMSSW_4_4_0_HLT23)
...
HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/cerminar/HLTTau3Mu/V7')
)
...
hltDimuonL1HQ2p1Filtered0 = cms.EDFilter( "HLTMuonL1Filter",
...
hltTauTo2MuL2PreFiltered0 = cms.EDFilter( "HLTMuonL2PreFilter",
    ...
    PreviousCandTag = cms.InputTag( "hltDimuonL1HQ2p1Filtered0" ),
...
hltTauTo2MuTracFilter = cms.EDFilter( "HLTmmkFilter",
...
HLT_Tau2Mu_RegPixTrack_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0HighQ + hltPreTau2MuRegPixTrack + hltDimuonL1HQ2p1Filtered0 + HLTL2muonrecoSequence + hltTauTo2MuL2PreFiltered0 + HLTL3muonrecoSequence + hltTauTo2MuL3Filtered + hltDisplacedmumuVtxProducerTauTo2Mu + hltDisplacedmumuFilterTauTo2Mu + HLTTauTo2MuRegionalPixelRecoSequence + hltTauTo2MuTracFilter + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLTSchedule = cms.Schedule( *(HLT_Tau2Mu_RegPixTrack_v1, HLTriggerFinalPath ))
