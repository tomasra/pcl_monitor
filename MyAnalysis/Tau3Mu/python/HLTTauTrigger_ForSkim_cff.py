# /users/cerminar/Tau3MuTest01/V12 (CMSSW_5_2_0_pre5_HLT8)
...
HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/cerminar/Tau3MuTest01/V12')
)
...
hltMyPixelTracks = hltPixelTracks.clone()
# hltMyPixelTracks = cms.EDProducer( "PixelTrackProducer",
#     FilterPSet = cms.PSet( 
#       chi2 = cms.double( 1000.0 ),
#       nSigmaTipMaxTolerance = cms.double( 0.0 ),
#       ComponentName = cms.string( "PixelTrackFilterByKinematics" ),
...
hltTau2MuTkMuMuTkFilter = cms.EDFilter( "HLTMuMuTrkVertexFilter",
    saveTags = cms.bool( True ),
...
HLTRecopixelSequence = cms.Sequence( hltMyPixelTracks )

HLT_Tau2Mu_RegPixTrack_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0HighQ + hltPreTau2MuRegPixTrack + hltDimuonL1Filtered0 + HLTL2muonrecoSequence + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltTauTo2MuL3Filtered + hltDisplacedmumuVtxProducerTauTo2Mu + hltDisplacedmumuFilterTauTo2Mu + cms.SequencePlaceholder( "HLTEndSequence" ) )
...
HLT_Tau2Mu_ItTrack_v1 = cms.Path( HLTBeginSequence + hltL1sL1DoubleMu0HighQ + hltPreTau2MuItTrk + hltDimuonL1Filtered0 + HLTL2muonrecoSequence + hltDimuonL2PreFiltered0 + HLTL3muonrecoSequence + hltDoubleMuTau2MuL3Filtered + hltDisplacedmumuVtxProducerDoubleMuTau2Mu + hltDisplacedmumuFilterDoubleMuTau2Mu + HLTDoLocalPixelSequence + HLTRecopixelSequence + HLTDoLocalStripSequence + HLTIterativeTracking + hltTau2MuTkAllTracks + hltTau2MuTkMuMuTkFilter + cms.SequencePlaceholder( "HLTEndSequence" ) )


HLTSchedule = cms.Schedule( *(HLT_Tau2Mu_RegPixTrack_v1, HLT_Tau2Mu_RegPixTrack_Tight_v1, HLT_Tau2Mu_ItTrack_v1 ))
