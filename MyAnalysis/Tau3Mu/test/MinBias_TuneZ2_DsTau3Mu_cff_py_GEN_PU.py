...
# with command line options: MyAnalysis/Tau3Mu/MinBias_TuneZ2_DsTau3Mu_cff.py -s GEN --geometry DB --datatier GEN --conditions START44_V7::All -n 10000 --eventcontent GENRAW --pileup=HighLumiPileUp --no_exec
...
process.GENRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2_DsTau3Mu_cff_py_GEN_PU.root'),
