...
# with command line options: MyAnalysis/Tau3Mu/python/MinBias_TuneZ2_DsPhiTo2MuPhi_2Mu_cff.py -s GEN --geometry DB --datatier GEN --conditions START44_V7::All -n 10000 --eventcontent GENRAW --pileup=HighLumiPileUp --no_exec --mc
...
process.GENRAWoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MinBias_TuneZ2_DsPhiTo2MuPhi_2Mu_cff_py_GEN_PU.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.DsFilter+process.genParticlesForFilter+process.muonParticlesInAcc+process.twoMuonFilter)
