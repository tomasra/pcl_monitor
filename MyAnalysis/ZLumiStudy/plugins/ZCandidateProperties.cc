/** \class ZCandidateProperties
 *
 *  No description available.
 *
 *  $Date: 2012/06/11 21:58:45 $
 *  $Revision: 1.13 $
 */
...
class ZCandidateProperties : public edm::EDProducer {
 public:
  /// Constructor
  explicit ZCandidateProperties(const edm::ParameterSet&);
    
  /// Destructor
  ~ZCandidateProperties(){};  
...
ZCandidateProperties::ZCandidateProperties(const edm::ParameterSet& iConfig) :
...
void
ZCandidateProperties::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{  
  using namespace edm;
  using namespace std;
...
DEFINE_FWK_MODULE(ZCandidateProperties);
