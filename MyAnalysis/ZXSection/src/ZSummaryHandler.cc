...
//
ZSummaryHandler::ZSummaryHandler()
{

}

//
bool ZSummaryHandler::initTree(TTree *t, bool needsToRecreate)
{
  if(t==0) return false;
  t_ = t;
...
//
bool ZSummaryHandler::attachToTree(TTree *t)
{
  if(t==0) return false;
  t_ = t;
